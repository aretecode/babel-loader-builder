...
var TypeParameterApplication = function (_Type) {
  ...
  createClass(TypeParameterApplication, [{
    ...
    value: function collectErrors(validation, path, input) {
      ...
      return parent.collectErrors.apply(parent, [validation, path, input].concat(toConsumableArray(typeInstances)));
    }
  }, {
    key: 'accepts',
    value: function accepts(input) {
...
var ObjectTypeProperty = function (_Type) {
  ...
  function ObjectTypeProperty() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = ObjectTypeProperty.__proto__ || Object.getPrototypeOf(ObjectTypeProperty)).call.apply(_ref, [this].concat(args))), _this), _this.typeName = 'ObjectTypeProperty', _this.constraints = [], _temp), possibleConstructorReturn(_this, _ret);
  }
  // Ignore
...
var ObjectTypeCallProperty = function (_Type) {
  ...
  function ObjectTypeCallProperty() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = ObjectTypeCallProperty.__proto__ || Object.getPrototypeOf(ObjectTypeCallProperty)).call.apply(_ref, [this].concat(args))), _this), _this.typeName = 'ObjectTypeCallProperty', _temp), possibleConstructorReturn(_this, _ret);
  }
...
var ParameterizedFunctionType = function (_Type) {
  ...
  createClass(ParameterizedFunctionType, [{
    ...
    value: function collectErrors(validation, path, input) {
      ...
      return getPartial$1.apply(undefined, [this].concat(toConsumableArray(typeInstances))).collectErrors(validation, path, input);
    }
  }, {
    key: 'accepts',
    value: function accepts(input) {
    ...
    key: 'acceptsType',
    value: function acceptsType(input) {
      return getPartial$1(this).acceptsType(input);
    }
  }, {
    key: 'acceptsParams',
    value: function acceptsParams() {
...
var RefinmentType = function (_Type) {
  inherits(RefinmentType, _Type);

  function RefinmentType() {
    var _ref;

    var _temp, _this, _ret;

    classCallCheck(this, RefinmentType);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = RefinmentType.__proto__ || Object.getPrototypeOf(RefinmentType)).call.apply(_ref, [this].concat(args))), _this), _this.typeName = 'RefinmentType', _this.constraints = [], _temp), possibleConstructorReturn(_this, _ret);
  }

  createClass(RefinmentType, [{
    key: 'addConstraint',
    value: function addConstraint() {
      for (var _len2 = arguments.length, constraints = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        constraints[_key2] = arguments[_key2];
  ...
  createClass(TypeContext, [{
    ...
    value: function ref(subject) {
      ...
      if (typeInstances.length) {
        ...
        return (_target4 = target).apply.apply(_target4, toConsumableArray(typeInstances));
      } else {
        return target;
      }
    }
    ...
    value: function refinement(type) {
      var target = new RefinmentType(this);
      target.type = type;
...
function defineProperty(name, value) {
  Object.defineProperty(globalContext$1, name, {
    value: value
  });
}
...
defineProperty('RefinementType', RefinmentType);
...
module.exports = globalContext$1;
